        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>{{ __('Pending Project Entries') }}</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="{{ route('project-entries.show', $entry) }}" class="btn btn-sm btn-primary">{{ __('View') }}</a>
                                                <button type="button" class="btn btn-success btn-sm" 
                                                        onclick="openSignatureModal({{ $entry->id }}, 'project')">
                                                    {{ __('Approve') }}
                                                </button>
                                            </div>
                                        </td>
                    ...
                    @else
                        <div class="text-center py-5">
                            <div class="alert alert-success">
                                ...
                                <h5>{{ __('All Project Entries Approved!') }}</h5>
                                <p class="mb-0">{{ __('There are no pending project entries at this time.') }}</p>
                            </div>
                        </div>
    @endif
                </div>
