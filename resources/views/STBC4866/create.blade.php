...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                <div class="card-header">{{ __('Create STBC4866 Entry') }}</div>

                <div class="card-body">
                    <form action="{{ route('STBC4866.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('STBC4866.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
