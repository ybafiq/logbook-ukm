            ...
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <p class="form-control-plaintext">{{ $stbc4996Entry->activity }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="card">
                                <div class="card-body">
                                    <div style="white-space: pre-wrap;">{{ $stbc4996Entry->comment }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <img src="{{ asset('storage/' . $stbc4996Entry->image_path) }}" alt="Entry image" class="img-thumbnail" style="max-height: 150px;">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <form action="{{ route('STBC4996.destroy', $stbc4996Entry) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
