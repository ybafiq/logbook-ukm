    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('STBC4886.update', $stbc4886Entry) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="include_image"
                                           {{ ($stbc4886Entry->image_path || old('_include_image')) ? 'checked' : '' }}>
                            ...
                            <div class="card-body" id="image_fields"
                                 style="display: {{ ($stbc4886Entry->image_path || old('_include_image')) ? 'block' : 'none' }};">
                                @if($stbc4886Entry->image_path)
                                    <div class="mb-2">
                                        <p class="form-text">{{ __('Current image:') }}</p>
                                        <img src="{{ asset('storage/' . $stbc4886Entry->image_path) }}"
                                             alt="Entry image" class="img-thumbnail" style="max-height: 200px;">
                                    </div>
                                @endif
                                <div class="mb-3">
                                    <label for="image" class="form-label">
                                        {{ $stbc4886Entry->image_path ? __('Replace Image') : __('Image') }}
                                    </label>
